...
/**
 * Declares a header as required — the document says every 202 carries it — and then does not send it.
 */
final readonly class MissingHeaderResponse implements ApiResponseWithHeaders
{
    ...
    public static function headerTypes(): ResponseHeaders
    {
        return ResponseHeaders::create(
            ResponseHeader::create('X-Required', TypeReference::builtin(BuiltinType::string)),
        );
    }
